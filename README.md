# Module 4: Visualisations with NVivo

## Workshop Overview
In this workshop, you will learn how to create a variety of visualisations in NVivo using queries.

## Learning Objectives
By the end of this workshop you will understand how to:
1. Create and run a query
2. Create a word cloud
3. Create a matrix table for your coding 
4. Create a hierarchy and bar chart
